# رَون (ravon) — بهبود خوانایی صفحات فارسی
...
برای استفاده‌ی لوکال از فونت وزیر، می‌توانید آن را از [صفحه‌ی رسمی وزیر در گیت‌هاب](https://github.com/rastikerdar/vazir-font) دریافت و نصب کنید.  
